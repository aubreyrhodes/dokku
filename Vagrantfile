...
Vagrant::configure("2") do |config|
  ...
  config.vm.provision :shell, :inline => "apt-get update && apt-get -y install make curl software-properties-common python-software-properties && cd /root/dokku && #{make_cmd}"
end
